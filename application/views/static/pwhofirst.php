        ...
        <div id="dataTables">
             ...
             <?php  foreach($recent_jobs as $jobs):?>
				<div style="display:none;" id="job_id_<?php echo $jobs['job_id'];?>" class="fancyboxContent">
					...
					<form style="padding: 10px;" action="<?php echo base_url().'home/job_update';?>" method="post" >
					      ...
					      <input style="padding: 5px 10px; border-radius: 0; display: block; margin:10px auto 0; background: #ff7b54; color: #FFF;" class="btn" type="submit" value="Update" />
					</form>
