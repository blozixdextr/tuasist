<div id="content" class="container">
		...
		<div class="col-xs-10 col-xs-offset-1 task-form-container whiteContainer">
			...
			<?php echo form_open(base_url().'home/wpayment_settings/update/'.$user_id , array('class' => 'col-xs-8'));?>
			
				<div class="form_control_input">
					<p>Paypal Email ID</p>
                    <?php foreach($edit_data as $data){ ?>
					<input id="change" class="form-control" required size="50" type="email" name="paypal_email" style="height: auto;" value="<?php echo $data['paypal_email']; ?>">
				</div>
<?php } ?>
