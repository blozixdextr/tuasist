                                	...
                                	<tr>
                                        ...
                                        <td><?php echo $bid['bid_commands'];?></td>
                                         <td>
                                            ...
                                            <a href="<?php echo base_url();?>home/pjob_openreassigned/<?php echo $jobs['job_id'];?>/<?php echo $bid['userid'];?>/<?php echo $bid['bid_amt']; ?>/" onclick="return confirm('Are you sure to Assign?');">Assign</a> 
                                         </td>
                                    </tr>
                                  <?php endforeach; ?>
                                </tbody>
