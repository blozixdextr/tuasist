                                   ...
                                   <?php  foreach($recent_jobs as $jobs):?>
                                	<tr>
                                       ...
                                       <?php switch($jobs['jwork_status']) {
											 case '1':
											 echo "<td>New</td><td>-</td><td>-</td><td>-</td><td>-</td><td><a href=''>No of bids</a> - <a href='".base_url()."home/pjob_cancel/".$jobs['job_id']."' onclick=\"return confirm('Are you sure?');\">Cancel</a></td>";
											  break;
											  case '2':
											 ...
											 case '4':
											  ...
											  break;	
											  case '8':
											 echo "<td><span style=\"color:Red\">Rejected</span> </td><td>-</td><td>-</td><td>-</td><td>-</td><td><a href=\"#inline\" id=\"favouriteWorkers\" >Reassign</a></td>";
											 break;
										}?>
                                    </tr>
...
<div id="inline" class="fancyboxContent">
		<h5>Enter the Worker id</h5>
        <form style="padding: 10px; text-align: center;" action="<?php echo base_url().'home/directassign_change';?>" method="post" >
                 
                    		<input type="hidden" name="job_id" value="<?php echo @$jobs['job_id'];?>"/>
					    	<input type="text" name="work_id" value=""/>
                            <br/>
					      <input style="padding: 5px 10px; border-radius: 0; margin-top:10px; background: #ff7b54; color: #FFF;" class="btn" type="submit" value="Submit" />
					</form>
